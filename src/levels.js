...
Use arrow keys to turn and space bar for thrust.`,
        ...
        },
        {
            ...
            planetList: [
                { x: 100, y: 500, velX: 4, velY: -4, mass: 5000, img: sprites.planet[0] },
                { x: 400, y: 250, velX: -4, velY: -4, mass: 10000, img: sprites.planet[1] },
                { x:500, y: 400, velX: 4, velY: 4, mass: 10000, img: sprites.planet[0] },
                { x: 700, y: 250, velX: 4, mass: 5000, img: sprites.planet[1] },
            ],
            ship: { x: 100, y: 300, mass: 10, velY: 0 },
            home: { x: 860, y: windowHeight / 2, mass: 2000, img: sprites.home, r: 50 },
        },
        {
            ...
            planetList: [
                ...
                { x: 730, y: 550, velX: 0.05, velY: 0.05, mass: 10000, img: sprites.planet[1] },
